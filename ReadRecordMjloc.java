...
@Autonomous(name="Citit Miscari Mijloc", group="Robot")
public class ReadRecordMjloc extends LinearOpMode {

    File filaRoti = new File("/storage/emulated/0/FIRST/InputRoti2.txt");
    File filaBrat = new File("/storage/emulated/0/FIRST/InputBrat2.txt");
    ...
    public void runOpMode() {
        ...
        double timpBrat = Double.parseDouble(urmatorulCuvantBrat())  + 300;
