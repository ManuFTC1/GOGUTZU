...
@Autonomous(name="Citit Miscari Dreapta", group="Robot")
public class ReadRecordDreapta extends LinearOpMode {

    File filaRoti = new File("/storage/emulated/0/FIRST/InputRoti3.txt");
    File filaBrat = new File("/storage/emulated/0/FIRST/InputBrat3.txt");
    ...
    public void runOpMode() {
        ...
        double timpBrat = Double.parseDouble(urmatorulCuvantBrat()) + 400;//pentrtu crist
        ...
        while (opModeIsActive()) {
            ...
            switch (manevraBrat) {
                ...
                case "a":
                    ...
                    break;
                case "x":
                    if (timpBrat + delayBrat > runtimeBrat.milliseconds() + 5)
